...
import { Avatar, Breadcrumb, Button, Layout, Nav, Tabs } from '@douyinfe/semi-ui'
import {
  IconBell,
  IconBytedanceLogo,
  IconHelpCircle,
...
function App(): React.JSX.Element {
  const webview = useRef<WebAction>(null)
    ...
    >
      ...
      <Layout>
        ...
        >
          ...
          >
            <Tabs className={'fullsize-tabs'}>
              <Tabs.TabPane tab="模版" itemKey="1">
                <NativeWebView
